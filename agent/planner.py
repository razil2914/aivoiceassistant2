...
Goal: "makine mhendislii hakknda aratrma yap ve not defterine kaydet"
Steps:
...
Goal: "Bitcoin fiyat nedir"
Steps:
  1. web_search | query: "Bitcoin price today USD"

Goal: "Masastndeki dosyalar listele ve en byk 5 dosyay bul"
Steps:
  1. file_controller | action: list, path: desktop
  2. file_controller | action: largest, path: desktop, count: 5

Goal: "WhatsApp'tan Ahmet'e yarn toplant var de"
Steps:
  1. send_message | receiver: Ahmet, message_text: "Yarn toplant var", platform: WhatsApp

Goal: "Saati a ve 30 dakika sonraya hatrlatc kur"
Steps:
  1. reminder | date: [today], time: [now+30min], message: "Hatrlatc"
